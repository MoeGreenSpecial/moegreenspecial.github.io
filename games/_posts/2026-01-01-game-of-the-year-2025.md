---
layout: game-list
excerpt: Game of the Year 2025. Spoiler alert - it's the obvious one.
tags: goty
...
1. ![Clair Obscur: Expedition 33](https://images.igdb.com/igdb/image/upload/t_cover_big_2x/co9gam.jpg) [Clair Obscur: Expedition 33](https://backloggd.com/u/MoeGreenSpecial/review/3027652/)
    ...
    Clair Obscur: Expedition 33 is not only easily my game of the year, it also has entered my personal pantheon of all-time favorites.

2. ![Avowed](https://images.igdb.com/igdb/image/upload/t_cover_big_2x/co7nbb.jpg) [Avowed](https://backloggd.com/u/MoeGreenSpecial/review/2822430/)

    Avowed stands out to me as the Action RPG that made all the right small twists to the formula.  It really felt like whenever Obsidian had a choice to make about the game, they chose the option that would be the most fun.  It's not an overly long game, and instead of having one gigantic open world it's divided up into several smaller maps to explore.  Since the maps are smaller in scale, the team at Obsidian were able to spend more time hand-crafting each of them.  And that, in turn, made it incredibly fun to explore the world because each map was densely packed with things to find and do.  The world designs themselves are colorful and avoid the usual drab browns and grays of fantasy RPGs.
...
4. ![Dispatch](https://images.igdb.com/igdb/image/upload/t_cover_big_2x/cob5ql.jpg) [Dispatch](https://backloggd.com/u/MoeGreenSpecial/review/3654681/)
    ...
    Dispatch is the best Telltale style game to date. It has incredible story, writing, and voice acting.  Each episode is only about an hour long, so none of it overstays its welcome either.  The actual dispatching is OK - although if you don't do well on a shift that can quickly snowball as you won't have enough XP to do well in the future.  Even so, it never stopped me from enjoying the rest of the game.

5. ![Doom: The Dark Ages](https://images.igdb.com/igdb/image/upload/t_cover_big_2x/co9b3o.jpg) [Doom: The Dark Ages](https://backloggd.com/u/MoeGreenSpecial/review/2893792/)

    The third entry in the modern Doom series continues the series' incredibly fun combat encounters, but this time with a melee focus.  This causes the gameplay to be a bit slower than the last entries, but even so the shield was incredibly fun to use.  Graphically, of course, this game is gorgeous to look at, and it runs incredibly smoothly.  The story was completely nonsensical to me, but that doesn't take away from just how fun Doom: The Dark Ages was to play.

6. ![Mafia: The Old Country](https://images.igdb.com/igdb/image/upload/t_cover_big_2x/coa9dq.jpg) [Mafia: The Old Country](https://backloggd.com/u/MoeGreenSpecial/review/3235000/)

    Mafia: The Old Country really evokes the feeling that you're playing a classic mob movie, with more than just a little influence of The Godfather present throughout.  Gameplay wise, it's fine.  The stealth and third person shooting sequences were good enough, although I was not a fan of the knife-fight bits.  Structurally, the game is a little odd, where collectibles are scattered through an open world that really only seems to exist to hold those collectibles.  Since the open world isn't really accessible when doing the linear story sequences, having the open world at all felt superfluous.

    However, all of that said, I really did enjoy this. Playing as what was effectively a more competent version of Fabrizio, with the gorgeous cinematics and character work being done through the story, felt like something that's almost specifically made for me. And wow did it work. 

7. ![Donkey Kong Bananza](https://images.igdb.com/igdb/image/upload/t_cover_big_2x/coa082.jpg) [Donkey Kong Bananza](https://backloggd.com/u/MoeGreenSpecial/review/3291458/)

    Donkey Kong Bananza was good fun for a while, but did suffer from becoming a bit repetitive as it went on. The gameplay and controls felt good, and the different abilities used to solve different types of problems were unique and fun as well. However, despite having a variety of different levels to play in, the core loop of finding hidden bananas and fossils eventually wore thin, and by the end, I never felt much motivation to go back to the post-game content.

8. ![Ball x Pit](https://images.igdb.com/igdb/image/upload/t_cover_big_2x/co9xid.jpg) [Ball x Pit](https://backloggd.com/u/MoeGreenSpecial/review/3642143/)

    Vampire Survivors meets Arkanoid, with a little bit of base building thrown in for good measure. Ball x Pit is probably the best of the Vampire Survivors-likes that I've played.  The core gameplay loop of going on a run to unlock money and blueprints that can then be used to upgrade your base, which then makes you stronger for the next run feels tight and satisfying. It never feels like it's dragging too much, and pretty much always feels like there's a goal to work towards.

    This is also one of the better entries in the genre of having you change up your play style from run to run. While the individual levels aren't too different from one another, the characters themselves all have unique quirks to their gameplay that force you to play them differently. While the core gameplay isn't difficult, having these tweaks is a nice way to keep the game fresh and engaging.
...
2. ![Persona 3 Reload](https://images.igdb.com/igdb/image/upload/t_cover_big_2x/co6z12.jpg) [Persona 3 Reload]({% post_url games/2026-01-12-persona-3-reload %})
...
3. ![Alan Wake II](https://images.igdb.com/igdb/image/upload/t_cover_big/co6jar.jpg) [Alan Wake II](https://backloggd.com/u/MoeGreenSpecial/review/3160527/)
    ...
    Alan Wake II is really great at what it does, although what it does is not exactly for me.  It's an excellent survival horror game, which excels at building up a horror atmosphere throughout.  While I understand that the genre demands it, but I'm not a big fan of slow movement and very limited supplies and that was a bit off-putting to me.
